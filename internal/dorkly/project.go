...
// Project is the brightly representation of a LaunchDarkly project
type Project struct {
...
// toRelayArchive converts a brightly Project to a RelayArchive for consumption by ld-relay
