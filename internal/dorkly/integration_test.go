...
// This test ensures the ld-relay can load a brightly-generated archive and serve flags from it.
// It serves as a partial integration test for the brightly project.
func TestDocker_LdRelayCanLoadArchive(t *testing.T) {
	...
	containerReq := testcontainers.ContainerRequest{
		...
		Files: []testcontainers.ContainerFile{{
			...
			ContainerFilePath: "/brightly/flags.tar.gz",
			FileMode:          0755,
		}},
